...
- 35645d9: All commands and their corresponding TypeScript types are now exported from `@pikun/core` so they can be imported and referenced directly by consumers. This makes it easier to build typed helpers, extensions, and tests that depend on the command signatures.
  ...
  ```ts
  import { commands } from '@pikun/core';
  ```

  Notes:

  - This is a non-breaking, additive change. It improves ergonomics for TypeScript consumers.
  - If you rely on previously private/internal types, prefer the exported types from `@pikun/core` going forward.
...
- 75cabde: Fix: Avoid the JSX Runtime to globally overwrite React's Element types when `/** @jsxImportSource @pikun/core */` is not used
  - @pikun/pm@3.0.3
...
- 0e3207f: Add support for [markviews](https://prosemirror.net/docs/ref/#view.MarkView), which allow you to render custom views for marks within the editor. This is useful for rendering custom UI for marks, like a color picker for a text color mark or a link editor for a link mark.
  ...
  To use a React component for a markview, you can use the `@pikun/react` package:

  ```ts
  import { Mark } from '@pikun/core';
  import { ReactMarkViewRenderer } from '@pikun/react';
  ...
  ```tsx
  import { MarkViewContent, MarkViewRendererProps } from '@pikun/react';
  ...
  To use a Vue 3 component for a markview, you can use the `@pikun/vue-3` package:

  ```ts
  import { Mark } from '@pikun/core';
  import { VueMarkViewRenderer } from '@pikun/vue-3';
  ...
  <script>
  import { MarkViewContent, markViewProps } from '@pikun/vue-3';
  export default {
    components: {
      MarkViewContent,
    },
...
- 704f462: This introduces a new behavior for the editor, the ability to be safely run on the server-side (without rendering).
  ...
  editor
    ...
    .setContent({
      type: 'doc',
      content: [{ type: 'paragraph', content: [{ type: 'text', text: 'XYZ' }] }],
    })
    .run();
...
- @pikun/pm@2.5.0-pre.16

## 2.5.0-pre.15

### Patch Changes

- @pikun/pm@2.5.0-pre.15

## 2.5.0-pre.14

### Patch Changes

- @pikun/pm@2.5.0-pre.14
...
- 509676e: Vue 3 bubble menus are properly synchronized with state transitions with the new beforeTransaction hook which is fired before the transaction is applied to the view
  - @pikun/pm@2.5.0-pre.8

## 2.5.0-pre.7

### Patch Changes

- @pikun/pm@2.5.0-pre.7
...
**Note:** Version bump only for package @pikun/core
...
- Mark `@pikun/react` and `@pikun/core` as side effect free ([#2361](https://github.com/ueberdosis/tiptap/issues/2361)) ([e609b2d](https://github.com/ueberdosis/tiptap/commit/e609b2d11615dd85fd219731d1b73deaeccccd69))
...
# [2.0.0-beta.183](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.182...@pikun/core@2.0.0-beta.183) (2022-09-03)
...
# [2.0.0-beta.182](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.181...@pikun/core@2.0.0-beta.182) (2022-07-06)
...
# [2.0.0-beta.181](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.180...@pikun/core@2.0.0-beta.181) (2022-06-27)
...
# [2.0.0-beta.180](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.179...@pikun/core@2.0.0-beta.180) (2022-06-20)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.179](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.177...@pikun/core@2.0.0-beta.179) (2022-06-17)

### Reverts

- Revert "Publish" ([9c38d27](https://github.com/ueberdosis/tiptap/commit/9c38d2713e6feac5645ad9c1bfc57abdbf054576))

# [2.0.0-beta.177](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.177...@pikun/core@2.0.0-beta.177) (2022-06-17)

### Reverts

- Revert "Publish" ([9c38d27](https://github.com/ueberdosis/tiptap/commit/9c38d2713e6feac5645ad9c1bfc57abdbf054576))

# [2.0.0-beta.176](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.175...@pikun/core@2.0.0-beta.176) (2022-05-18)
...
# [2.0.0-beta.175](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.174...@pikun/core@2.0.0-beta.175) (2022-04-27)

### Bug Fixes

- don't override behaviour of Home / End in pc keymap ([d270419](https://github.com/ueberdosis/tiptap/commit/d270419ad8dc6182a949c5d263c47e90ee4466ff))

# [2.0.0-beta.174](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.173...@pikun/core@2.0.0-beta.174) (2022-02-07)

### Bug Fixes

- revert changes to selectAll command, fix [#2491](https://github.com/ueberdosis/tiptap/issues/2491) ([bdab760](https://github.com/ueberdosis/tiptap/commit/bdab760cdbf89da7a56dcc1a183010974d2e1290))

# [2.0.0-beta.173](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.172...@pikun/core@2.0.0-beta.173) (2022-02-07)

### Bug Fixes

- fix RangeError bug when selecting all text, fix [#2490](https://github.com/ueberdosis/tiptap/issues/2490) ([70422dd](https://github.com/ueberdosis/tiptap/commit/70422dd107ed1ecdd8dfe41a8a93297124d2f1e0))

# [2.0.0-beta.172](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.171...@pikun/core@2.0.0-beta.172) (2022-02-03)

### Bug Fixes

- don’t add tabindex when readonly, fix [#2458](https://github.com/ueberdosis/tiptap/issues/2458) ([01411f8](https://github.com/ueberdosis/tiptap/commit/01411f8462e8a36f96e56cdba227a9e5bb3e1812))

# [2.0.0-beta.171](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.170...@pikun/core@2.0.0-beta.171) (2022-01-28)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.170](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.169...@pikun/core@2.0.0-beta.170) (2022-01-27)

### Bug Fixes

- set max textselection correctly, fix [#2401](https://github.com/ueberdosis/tiptap/issues/2401) ([4be16fc](https://github.com/ueberdosis/tiptap/commit/4be16fcd2e6c107e59679eebf1ea1d6112a88afb))

# [2.0.0-beta.169](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.168...@pikun/core@2.0.0-beta.169) (2022-01-27)

### Bug Fixes

- fix End key handler, fix [#2446](https://github.com/ueberdosis/tiptap/issues/2446) ([b584920](https://github.com/ueberdosis/tiptap/commit/b584920ea172bc9f5207b8d03cb2b7f80925a5be))

# [2.0.0-beta.168](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.167...@pikun/core@2.0.0-beta.168) (2022-01-26)

### Bug Fixes

- add attributes to pre tag instead of code tag by default, fix [#2440](https://github.com/ueberdosis/tiptap/issues/2440) ([85fcc29](https://github.com/ueberdosis/tiptap/commit/85fcc29ac6ef9e07847d5e0a5cdd318f4300a832))

# [2.0.0-beta.167](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.166...@pikun/core@2.0.0-beta.167) (2022-01-25)
...
# [2.0.0-beta.166](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.165...@pikun/core@2.0.0-beta.166) (2022-01-20)

### Bug Fixes

- insertContent keeps marks when using plain text, fix [#2406](https://github.com/ueberdosis/tiptap/issues/2406) ([d242706](https://github.com/ueberdosis/tiptap/commit/d2427064ff1765004173f3c718cd1e4eba4dc355))

# [2.0.0-beta.165](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.164...@pikun/core@2.0.0-beta.165) (2022-01-20)

### Bug Fixes

- fix removing the caret on blur in some situations when using safari, fix [#2405](https://github.com/ueberdosis/tiptap/issues/2405) ([9d31712](https://github.com/ueberdosis/tiptap/commit/9d317128a08a66f18c4d51385b6a9fccc5cd66f4))

# [2.0.0-beta.164](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.163...@pikun/core@2.0.0-beta.164) (2022-01-20)

### Bug Fixes

- run pasterules for pasted content, fix [#2408](https://github.com/ueberdosis/tiptap/issues/2408) ([bc03c0d](https://github.com/ueberdosis/tiptap/commit/bc03c0d77812376f910accba1fb130c751ea7f0d))

# [2.0.0-beta.163](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.162...@pikun/core@2.0.0-beta.163) (2022-01-13)

### Bug Fixes

- support all characters for suggestion char, fix [#2385](https://github.com/ueberdosis/tiptap/issues/2385) ([42d3ee8](https://github.com/ueberdosis/tiptap/commit/42d3ee8fc9882a9fb9f87e696cebd0e6146d2e62))

# [2.0.0-beta.162](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.161...@pikun/core@2.0.0-beta.162) (2022-01-11)

### Bug Fixes

- Mark `@pikun/react` and `@pikun/core` as side effect free ([#2361](https://github.com/ueberdosis/tiptap/issues/2361)) ([e609b2d](https://github.com/ueberdosis/tiptap/commit/e609b2d11615dd85fd219731d1b73deaeccccd69))

# [2.0.0-beta.161](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.160...@pikun/core@2.0.0-beta.161) (2022-01-10)

### Bug Fixes

- add way to cancel inputrules and pasterules ([#2368](https://github.com/ueberdosis/tiptap/issues/2368)) ([669efd0](https://github.com/ueberdosis/tiptap/commit/669efd00e9a508bbb4d6275d47092470b2e16561))

# [2.0.0-beta.160](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.159...@pikun/core@2.0.0-beta.160) (2022-01-04)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.159](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.158...@pikun/core@2.0.0-beta.159) (2021-12-22)

### Bug Fixes

- allow input rules after hard break, fix [#2302](https://github.com/ueberdosis/tiptap/issues/2302) ([ded6f96](https://github.com/ueberdosis/tiptap/commit/ded6f9618fb588f2c259edc9bc77415f8723431c))

# [2.0.0-beta.158](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.157...@pikun/core@2.0.0-beta.158) (2021-12-17)

### Bug Fixes

- remove empty mark attributes from getDebugJSON ([07cabe6](https://github.com/ueberdosis/tiptap/commit/07cabe65f4852a3c7fcab5c60b51318a05272aee))

# [2.0.0-beta.157](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.156...@pikun/core@2.0.0-beta.157) (2021-12-16)

### Bug Fixes

- Improve backspace handling ([#2284](https://github.com/ueberdosis/tiptap/issues/2284)), fix [#2281](https://github.com/ueberdosis/tiptap/issues/2281) ([8ed485b](https://github.com/ueberdosis/tiptap/commit/8ed485ba53e809207a23ca6871aab2eb0806f0ab))

# [2.0.0-beta.156](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.155...@pikun/core@2.0.0-beta.156) (2021-12-15)

### Bug Fixes

- prevent error in toggleList command, fix [#2279](https://github.com/ueberdosis/tiptap/issues/2279) ([66eb2f2](https://github.com/ueberdosis/tiptap/commit/66eb2f2a47cdf21590881153a6cb6b1f3f38641a))

# [2.0.0-beta.155](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.154...@pikun/core@2.0.0-beta.155) (2021-12-15)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.154](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.153...@pikun/core@2.0.0-beta.154) (2021-12-14)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.153](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.152...@pikun/core@2.0.0-beta.153) (2021-12-13)
...
# [2.0.0-beta.152](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.151...@pikun/core@2.0.0-beta.152) (2021-12-10)

### Features

- join lists on toggleList ([#2260](https://github.com/ueberdosis/tiptap/issues/2260)), fix [#1329](https://github.com/ueberdosis/tiptap/issues/1329) ([126ad72](https://github.com/ueberdosis/tiptap/commit/126ad722c7a1c4131fa332deb9f333798d4af056))

# [2.0.0-beta.151](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.150...@pikun/core@2.0.0-beta.151) (2021-12-08)

### Features

- add some improvements to `CharacterCount` extension ([#2256](https://github.com/ueberdosis/tiptap/issues/2256)), fix [#1049](https://github.com/ueberdosis/tiptap/issues/1049), fix [#1550](https://github.com/ueberdosis/tiptap/issues/1550), fix [#1839](https://github.com/ueberdosis/tiptap/issues/1839), fix [#2245](https://github.com/ueberdosis/tiptap/issues/2245) ([5daa870](https://github.com/ueberdosis/tiptap/commit/5daa870b0906f0387fe07041681bc6f5b3774617))

# [2.0.0-beta.150](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.149...@pikun/core@2.0.0-beta.150) (2021-12-06)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.149](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.148...@pikun/core@2.0.0-beta.149) (2021-12-05)

### Bug Fixes

- add support for multiple ranges in clipboardTextSerializer, fix [#1982](https://github.com/ueberdosis/tiptap/issues/1982) ([98a1cb3](https://github.com/ueberdosis/tiptap/commit/98a1cb36408765f0f042e7abb8dad3c19cdf0a09))

# [2.0.0-beta.148](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.147...@pikun/core@2.0.0-beta.148) (2021-12-03)

### Bug Fixes

- initialize autofocus selection in `createView` ([#2212](https://github.com/ueberdosis/tiptap/issues/2212)) ([de39853](https://github.com/ueberdosis/tiptap/commit/de39853026ee63bb558ed59b1dab3899c07ae073))

# [2.0.0-beta.147](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.146...@pikun/core@2.0.0-beta.147) (2021-12-03)

### Features

- Add support for autolink ([#2226](https://github.com/ueberdosis/tiptap/issues/2226)) ([3d68981](https://github.com/ueberdosis/tiptap/commit/3d68981b47d087fff40549d2143eb952fc9e0a50))

# [2.0.0-beta.146](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.145...@pikun/core@2.0.0-beta.146) (2021-12-02)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.145](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.144...@pikun/core@2.0.0-beta.145) (2021-12-02)

### Bug Fixes

- remove defaultOptions fallback, fix [#2219](https://github.com/ueberdosis/tiptap/issues/2219) ([20b6d79](https://github.com/ueberdosis/tiptap/commit/20b6d79f33217d0f8fcd416a1cc54712ea6fc743))

# [2.0.0-beta.144](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.143...@pikun/core@2.0.0-beta.144) (2021-12-02)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.143](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.142...@pikun/core@2.0.0-beta.143) (2021-11-25)

### Features

- add scrollIntoView option to focus command, fix [#2172](https://github.com/ueberdosis/tiptap/issues/2172) ([e0f6490](https://github.com/ueberdosis/tiptap/commit/e0f64904b665512fbde80db87bb394557433e164))

# [2.0.0-beta.142](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.141...@pikun/core@2.0.0-beta.142) (2021-11-23)

### Features

- add defaultBlockAt helper ([403c147](https://github.com/ueberdosis/tiptap/commit/403c147d4d0875cb8ca63d88abfec94093ff7926))

# [2.0.0-beta.141](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.140...@pikun/core@2.0.0-beta.141) (2021-11-22)
...
# [2.0.0-beta.140](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.139...@pikun/core@2.0.0-beta.140) (2021-11-18)
...
# [2.0.0-beta.139](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.138...@pikun/core@2.0.0-beta.139) (2021-11-17)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.138](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.137...@pikun/core@2.0.0-beta.138) (2021-11-10)
...
# [2.0.0-beta.137](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.136...@pikun/core@2.0.0-beta.137) (2021-11-09)

### Bug Fixes

- don't remove the tiptap styles on destroy, fix [#2120](https://github.com/ueberdosis/tiptap/issues/2120), fix [#2143](https://github.com/ueberdosis/tiptap/issues/2143) ([a0a88ac](https://github.com/ueberdosis/tiptap/commit/a0a88acd13ee221587834def8d2655ac13233f27))

# [2.0.0-beta.136](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.135...@pikun/core@2.0.0-beta.136) (2021-11-09)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.135](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.134...@pikun/core@2.0.0-beta.135) (2021-11-09)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.134](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.133...@pikun/core@2.0.0-beta.134) (2021-11-09)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.133](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.132...@pikun/core@2.0.0-beta.133) (2021-11-08)
...
# [2.0.0-beta.132](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.131...@pikun/core@2.0.0-beta.132) (2021-11-08)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.131](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.130...@pikun/core@2.0.0-beta.131) (2021-11-05)

### Bug Fixes

- improve JSONContent type to allow pure JSON content ([ce7f52a](https://github.com/ueberdosis/tiptap/commit/ce7f52a8f0c278ef39b25010950dd734bebd679b))

# [2.0.0-beta.130](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.129...@pikun/core@2.0.0-beta.130) (2021-10-31)

### Bug Fixes

- prevent RangeError for posToDOMRect, fix [#2112](https://github.com/ueberdosis/tiptap/issues/2112) ([010418d](https://github.com/ueberdosis/tiptap/commit/010418d0fd04ebef10180a3559abfbbd24b6a959))

# [2.0.0-beta.129](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.128...@pikun/core@2.0.0-beta.129) (2021-10-26)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.128](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.127...@pikun/core@2.0.0-beta.128) (2021-10-25)

### Bug Fixes

- fix storage context when using configure ([ef254ce](https://github.com/ueberdosis/tiptap/commit/ef254cead7b9be052ec0211849fb78ae577095dd))

# [2.0.0-beta.127](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.126...@pikun/core@2.0.0-beta.127) (2021-10-22)
...
# [2.0.0-beta.126](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.125...@pikun/core@2.0.0-beta.126) (2021-10-22)
...
# [2.0.0-beta.125](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.124...@pikun/core@2.0.0-beta.125) (2021-10-14)

### Bug Fixes

- check for storedMarks in getMarkAttributes, fix [#2039](https://github.com/ueberdosis/tiptap/issues/2039) ([22c82ba](https://github.com/ueberdosis/tiptap/commit/22c82ba61fe14db19e1049dfcf9bef0b7abb796d))

# [2.0.0-beta.124](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.123...@pikun/core@2.0.0-beta.124) (2021-10-14)

### Bug Fixes

- fix type for insertContent command ([4295c6b](https://github.com/ueberdosis/tiptap/commit/4295c6bd2181bdaa98ef7777bfab44efbcf22a32))

# [2.0.0-beta.123](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.122...@pikun/core@2.0.0-beta.123) (2021-10-14)
...
# [2.0.0-beta.122](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.121...@pikun/core@2.0.0-beta.122) (2021-10-10)

### Bug Fixes

- allow to re-apply current mark for input rules and paste rules, fix [#2003](https://github.com/ueberdosis/tiptap/issues/2003) ([3958bf1](https://github.com/ueberdosis/tiptap/commit/3958bf1c226621142e9216c8eda91a70b71a211a))

# [2.0.0-beta.121](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.120...@pikun/core@2.0.0-beta.121) (2021-10-10)

### Bug Fixes

- do not apply paste rules for ProseMirror HTML ([9d281e9](https://github.com/ueberdosis/tiptap/commit/9d281e9e998a5cfa9ca1002ad428caf1cee59682))

# [2.0.0-beta.120](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.119...@pikun/core@2.0.0-beta.120) (2021-10-08)

### Bug Fixes

- fix mappes positions for paste rules, fix [#2002](https://github.com/ueberdosis/tiptap/issues/2002) ([770c4e1](https://github.com/ueberdosis/tiptap/commit/770c4e18e19504f4c44feb85b7d202fcc5201b12))

# [2.0.0-beta.119](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.118...@pikun/core@2.0.0-beta.119) (2021-10-08)

### Features

- Integrate input rules and paste rules into the core ([#1997](https://github.com/ueberdosis/tiptap/issues/1997)) ([723b955](https://github.com/ueberdosis/tiptap/commit/723b955cecc5c92c8aad897ce16c60fb62976571))

# [2.0.0-beta.118](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.117...@pikun/core@2.0.0-beta.118) (2021-10-03)

### Bug Fixes

- fix order of executed plugins, fix [#1547](https://github.com/ueberdosis/tiptap/issues/1547) ([f8efdf7](https://github.com/ueberdosis/tiptap/commit/f8efdf797a10a01235b75091729b15aca076e47a))

# [2.0.0-beta.117](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.116...@pikun/core@2.0.0-beta.117) (2021-10-02)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.116](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.115...@pikun/core@2.0.0-beta.116) (2021-09-30)

### Features

- [#1898](https://github.com/ueberdosis/tiptap/issues/1898) Made the EventEmitter generic to improve the types of the tiptap events ([#1959](https://github.com/ueberdosis/tiptap/issues/1959)) ([54e85fd](https://github.com/ueberdosis/tiptap/commit/54e85fd28491fcf2d5a88fb5abda1f8414ada92b))

# [2.0.0-beta.115](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.114...@pikun/core@2.0.0-beta.115) (2021-09-29)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.114](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.113...@pikun/core@2.0.0-beta.114) (2021-09-28)

### Bug Fixes

- getHTMLFromFragment now expects a fragment instead of node ([2c9cf03](https://github.com/ueberdosis/tiptap/commit/2c9cf03398e2b14fceaec4386fdb53cae5261ae7))

# [2.0.0-beta.113](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.112...@pikun/core@2.0.0-beta.113) (2021-09-27)
...
# [2.0.0-beta.112](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.111...@pikun/core@2.0.0-beta.112) (2021-09-23)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.111](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.110...@pikun/core@2.0.0-beta.111) (2021-09-22)
...
# [2.0.0-beta.110](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.109...@pikun/core@2.0.0-beta.110) (2021-09-21)

### Bug Fixes

- call selectAll on 'cmd+a', set a TextSelection instead of AllSelection, fix [#1908](https://github.com/ueberdosis/tiptap/issues/1908) ([bad16d9](https://github.com/ueberdosis/tiptap/commit/bad16d9f3a9f47db83ad170c6de4d6ff11dba007))

# [2.0.0-beta.109](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.108...@pikun/core@2.0.0-beta.109) (2021-09-21)

### Features

- add enableCoreExtensions flag ([#1923](https://github.com/ueberdosis/tiptap/issues/1923)) ([4178281](https://github.com/ueberdosis/tiptap/commit/4178281a749f2b7641740c0be1efae77ecb74587))

# [2.0.0-beta.108](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.107...@pikun/core@2.0.0-beta.108) (2021-09-20)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.107](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.106...@pikun/core@2.0.0-beta.107) (2021-09-18)

### Bug Fixes

- fix extension name for clipboardTextSerializer ([15f90ec](https://github.com/ueberdosis/tiptap/commit/15f90ec5916460359827f7073e5c36147867fef7))

# [2.0.0-beta.106](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.105...@pikun/core@2.0.0-beta.106) (2021-09-15)

### Bug Fixes

- improve active mark detection for inline nodes, fix [#1893](https://github.com/ueberdosis/tiptap/issues/1893) ([6437790](https://github.com/ueberdosis/tiptap/commit/6437790431e564c871ebe7daa3aab6e4d3577a8f))

# [2.0.0-beta.105](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.104...@pikun/core@2.0.0-beta.105) (2021-09-09)

### Features

- add getText() and generateText() methods (fix [#1428](https://github.com/ueberdosis/tiptap/issues/1428)) ([#1875](https://github.com/ueberdosis/tiptap/issues/1875)) ([fe6a3e7](https://github.com/ueberdosis/tiptap/commit/fe6a3e7491f6a42123d3d8a92ab588f2a40d7799))

# [2.0.0-beta.104](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.103...@pikun/core@2.0.0-beta.104) (2021-09-08)
...
# [2.0.0-beta.103](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.102...@pikun/core@2.0.0-beta.103) (2021-09-06)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.102](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.101...@pikun/core@2.0.0-beta.102) (2021-08-26)

### Bug Fixes

- fix focus on iOS, fix [#1806](https://github.com/ueberdosis/tiptap/issues/1806) ([3a06938](https://github.com/ueberdosis/tiptap/commit/3a0693869d10793620e0073b0782dd34ac5aea89))

# [2.0.0-beta.101](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.100...@pikun/core@2.0.0-beta.101) (2021-08-24)

### Bug Fixes

- add topNode to getDebugJSON ([f65e1b3](https://github.com/ueberdosis/tiptap/commit/f65e1b32a16c25622c2d507e74dd0dde9dac9376))

# [2.0.0-beta.100](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.99...@pikun/core@2.0.0-beta.100) (2021-08-20)
...
# [2.0.0-beta.99](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.98...@pikun/core@2.0.0-beta.99) (2021-08-13)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.98](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.97...@pikun/core@2.0.0-beta.98) (2021-08-13)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.97](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.96...@pikun/core@2.0.0-beta.97) (2021-08-13)

### Features

- add transaction to all events if possible, see [#1461](https://github.com/ueberdosis/tiptap/issues/1461) ([7f6ed0b](https://github.com/ueberdosis/tiptap/commit/7f6ed0b1c078985a1acee736bc605fb9f93b5af2))

# [2.0.0-beta.96](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.95...@pikun/core@2.0.0-beta.96) (2021-08-12)

### Bug Fixes

- fix some react focus issues ([#1724](https://github.com/ueberdosis/tiptap/issues/1724)), fix [#1716](https://github.com/ueberdosis/tiptap/issues/1716), fix [#1608](https://github.com/ueberdosis/tiptap/issues/1608), fix [#1520](https://github.com/ueberdosis/tiptap/issues/1520) ([956566e](https://github.com/ueberdosis/tiptap/commit/956566eaad0a522d6bc27d44594aa36d6c33f8b3))

# [2.0.0-beta.95](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.94...@pikun/core@2.0.0-beta.95) (2021-08-11)

### Bug Fixes

- improve calculation for min/max positions in selections, fix [#1588](https://github.com/ueberdosis/tiptap/issues/1588) ([9425e72](https://github.com/ueberdosis/tiptap/commit/9425e7249a15e0fb4e8c714545c09f367d216536))

# [2.0.0-beta.94](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.93...@pikun/core@2.0.0-beta.94) (2021-08-09)
...
# [2.0.0-beta.93](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.92...@pikun/core@2.0.0-beta.93) (2021-07-30)

### Bug Fixes

- revert async focus, fix [#1658](https://github.com/ueberdosis/tiptap/issues/1658) ([c9869c8](https://github.com/ueberdosis/tiptap/commit/c9869c8d3021510366a46e840a66e8c06a6586ed))

# [2.0.0-beta.92](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.91...@pikun/core@2.0.0-beta.92) (2021-07-28)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.91](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.90...@pikun/core@2.0.0-beta.91) (2021-07-28)

### Bug Fixes

- fix a bug in markPasteRule ([c2ccf68](https://github.com/ueberdosis/tiptap/commit/c2ccf68e8b4c869f707f3b1fdf51474e7f64b6f3))

# [2.0.0-beta.90](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.89...@pikun/core@2.0.0-beta.90) (2021-07-28)

### Features

- add deleteNode command ([73f1c50](https://github.com/ueberdosis/tiptap/commit/73f1c50bca8ffcd074388519eec9c659b0fda14c))

# [2.0.0-beta.89](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.88...@pikun/core@2.0.0-beta.89) (2021-07-27)

### Features

- add ignoreMutation option to NodeViewRenderer, fix [#1538](https://github.com/ueberdosis/tiptap/issues/1538) ([651e691](https://github.com/ueberdosis/tiptap/commit/651e6911e3ea5407df6a48783ee16733e0a4f474))

# [2.0.0-beta.88](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.87...@pikun/core@2.0.0-beta.88) (2021-07-26)

### Features

- Allow a rule to be skipped from the getAttributes callback in markPasteRule ([#1625](https://github.com/ueberdosis/tiptap/issues/1625)) ([9ffd58c](https://github.com/ueberdosis/tiptap/commit/9ffd58cf256bf3c0cd5a217b8933826c70b9b841))

# [2.0.0-beta.87](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.86...@pikun/core@2.0.0-beta.87) (2021-07-26)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.86](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.85...@pikun/core@2.0.0-beta.86) (2021-07-09)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.85](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.84...@pikun/core@2.0.0-beta.85) (2021-06-23)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.84](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.83...@pikun/core@2.0.0-beta.84) (2021-06-17)

### Bug Fixes

- improve types for generateHTML ([502b5b1](https://github.com/ueberdosis/tiptap/commit/502b5b1cc9f1a8beb49ef2da81a9db56c7e92424))

# [2.0.0-beta.83](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.82...@pikun/core@2.0.0-beta.83) (2021-06-15)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.82](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.81...@pikun/core@2.0.0-beta.82) (2021-06-14)
...
# [2.0.0-beta.81](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.80...@pikun/core@2.0.0-beta.81) (2021-06-07)
...
# [2.0.0-beta.80](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.79...@pikun/core@2.0.0-beta.80) (2021-06-03)

### Bug Fixes

- fix merging options on configure for multiple extension instances ([d037c56](https://github.com/ueberdosis/tiptap/commit/d037c5656a113ac7205104a815310727b23c30d4))

# [2.0.0-beta.79](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.77...@pikun/core@2.0.0-beta.79) (2021-06-02)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.77](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.76...@pikun/core@2.0.0-beta.77) (2021-06-02)

### Features

- add setMeta command ([36dad2b](https://github.com/ueberdosis/tiptap/commit/36dad2bbae5ed66077822330133a9d8ee0d28747))

# [2.0.0-beta.76](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.75...@pikun/core@2.0.0-beta.76) (2021-06-01)

### Bug Fixes

- remove custom coordsAtPos method, fix [#583](https://github.com/ueberdosis/tiptap/issues/583) ([485fb8c](https://github.com/ueberdosis/tiptap/commit/485fb8c74c831256aaa2cefdf130e05438c2e476))

# [2.0.0-beta.75](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.74...@pikun/core@2.0.0-beta.75) (2021-06-01)

### Bug Fixes

- prevent dispatch empty fragment when parsing content with insertContent ([2a4e02a](https://github.com/ueberdosis/tiptap/commit/2a4e02ade3b74999a9632673a607568644d6d26c))

# [2.0.0-beta.74](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.73...@pikun/core@2.0.0-beta.74) (2021-05-31)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.73](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.72...@pikun/core@2.0.0-beta.73) (2021-05-29)

### Bug Fixes

- check for excluded marks in isMarkActive, fix [#1388](https://github.com/ueberdosis/tiptap/issues/1388) ([3c4cc96](https://github.com/ueberdosis/tiptap/commit/3c4cc96fee7fc32e363d3b8a2503684435f30c35))

# [2.0.0-beta.72](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.71...@pikun/core@2.0.0-beta.72) (2021-05-28)

### Bug Fixes

- fix error when calculating contentMatch within clearNodes command, fix [#1361](https://github.com/ueberdosis/tiptap/issues/1361) ([3709668](https://github.com/ueberdosis/tiptap/commit/370966847efd7bbc1b033cf5952f2427e62c1525))

# [2.0.0-beta.71](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.70...@pikun/core@2.0.0-beta.71) (2021-05-28)

### Bug Fixes

- fix fragile schema validity test in splitBlock ([e52f41a](https://github.com/ueberdosis/tiptap/commit/e52f41ae7864210bc0e4107db21e09607d2e586f))

# [2.0.0-beta.70](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.69...@pikun/core@2.0.0-beta.70) (2021-05-28)

### Bug Fixes

- prevent bug when editor is destroyed very fast ([939fc3d](https://github.com/ueberdosis/tiptap/commit/939fc3d93ab67d54b7fe67b64c423290b3a40df8))

# [2.0.0-beta.69](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.68...@pikun/core@2.0.0-beta.69) (2021-05-27)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.68](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.67...@pikun/core@2.0.0-beta.68) (2021-05-24)

### Bug Fixes

- do not check for node selection within posToDOMRect ([c0e68d5](https://github.com/ueberdosis/tiptap/commit/c0e68d5a25608e0b6d9c127bbc507b4ba2a94a61))

# [2.0.0-beta.67](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.66...@pikun/core@2.0.0-beta.67) (2021-05-24)
...
# [2.0.0-beta.66](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.65...@pikun/core@2.0.0-beta.66) (2021-05-19)

### Bug Fixes

- preserve whitespace when using insertContent command ([8f10181](https://github.com/ueberdosis/tiptap/commit/8f101810feace676fedce449e71d3af1d152436b))

# [2.0.0-beta.65](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.64...@pikun/core@2.0.0-beta.65) (2021-05-18)

### Features

- allow number for setTextSelection and insertContentAt ([2f7a6ad](https://github.com/ueberdosis/tiptap/commit/2f7a6adca54290b65467121e55838e5cfcf9ea8b))

# [2.0.0-beta.64](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.63...@pikun/core@2.0.0-beta.64) (2021-05-18)
...
# [2.0.0-beta.63](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.62...@pikun/core@2.0.0-beta.63) (2021-05-18)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.62](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.61...@pikun/core@2.0.0-beta.62) (2021-05-17)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.61](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.60...@pikun/core@2.0.0-beta.61) (2021-05-17)
...
# [2.0.0-beta.60](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.59...@pikun/core@2.0.0-beta.60) (2021-05-13)

### Bug Fixes

- fix missing extensions when using `addExtension`, fix [#1309](https://github.com/ueberdosis/tiptap/issues/1309) ([28737b1](https://github.com/ueberdosis/tiptap/commit/28737b1631719315cebc354f7cb5a1d924b0b543))

# [2.0.0-beta.59](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.57...@pikun/core@2.0.0-beta.59) (2021-05-13)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.57](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.56...@pikun/core@2.0.0-beta.57) (2021-05-13)
...
# [2.0.0-beta.56](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.55...@pikun/core@2.0.0-beta.56) (2021-05-13)

### Bug Fixes

- fix a bug in detecting a current list in toggleList command ([a35b253](https://github.com/ueberdosis/tiptap/commit/a35b2533eb87c683c0bff56b574aff490f490980))

# [2.0.0-beta.55](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.54...@pikun/core@2.0.0-beta.55) (2021-05-11)
...
# [2.0.0-beta.54](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.53...@pikun/core@2.0.0-beta.54) (2021-05-09)

### Bug Fixes

- set correct priority when extending extensions, fix [#1288](https://github.com/ueberdosis/tiptap/issues/1288) ([b4e2b6f](https://github.com/ueberdosis/tiptap/commit/b4e2b6fc9dd722cce5ee85eb2df994453a0f5d39))

# [2.0.0-beta.53](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.52...@pikun/core@2.0.0-beta.53) (2021-05-07)

### Features

- add editor.getAttributes, deprecate editor.getNodeAttributes and editor.getMarkAttributes ([072905c](https://github.com/ueberdosis/tiptap/commit/072905cb95e022a37f5bc937889999bfbb33ad88))

# [2.0.0-beta.52](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.51...@pikun/core@2.0.0-beta.52) (2021-05-07)

### Features

- expose node helpers to core ([6048f9b](https://github.com/ueberdosis/tiptap/commit/6048f9b31b996b305f704c4ae3ed176fa42eb943))

# [2.0.0-beta.51](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.50...@pikun/core@2.0.0-beta.51) (2021-05-07)
...
# [2.0.0-beta.50](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.49...@pikun/core@2.0.0-beta.50) (2021-05-07)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.49](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.48...@pikun/core@2.0.0-beta.49) (2021-05-07)
...
# [2.0.0-beta.48](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.47...@pikun/core@2.0.0-beta.48) (2021-05-06)

### Bug Fixes

- revert adding type: module ([f8d6475](https://github.com/ueberdosis/tiptap/commit/f8d6475e2151faea6f96baecdd6bd75880d50d2c))

# [2.0.0-beta.47](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.46...@pikun/core@2.0.0-beta.47) (2021-05-06)

### Bug Fixes

- add exports to package.json ([1277fa4](https://github.com/ueberdosis/tiptap/commit/1277fa47151e9c039508cdb219bdd0ffe647f4ee))

# [2.0.0-beta.46](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.45...@pikun/core@2.0.0-beta.46) (2021-05-06)

### Features

- add addExtensions option ([26e672e](https://github.com/ueberdosis/tiptap/commit/26e672e2f02a8f94941c704f3cd6cc4adef40df7))

# [2.0.0-beta.45](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.44...@pikun/core@2.0.0-beta.45) (2021-05-06)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.44](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.43...@pikun/core@2.0.0-beta.44) (2021-05-05)

### Features

- remove deprecated commands insertHTML, insertNode and insertText ([86d570f](https://github.com/ueberdosis/tiptap/commit/86d570fb79b89a061cf1a5374a377ed6d9bca49e))

# [2.0.0-beta.43](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.42...@pikun/core@2.0.0-beta.43) (2021-05-05)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.42](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.41...@pikun/core@2.0.0-beta.42) (2021-05-04)

### Bug Fixes

- ignore editable in dispatchTransaction, fix [#1239](https://github.com/ueberdosis/tiptap/issues/1239) ([b3fb022](https://github.com/ueberdosis/tiptap/commit/b3fb0228e04a227bfc4536b167a93b3172169378))

# [2.0.0-beta.41](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.40...@pikun/core@2.0.0-beta.41) (2021-04-27)

### Bug Fixes

- fix onBeforeCreate event handler, fix [#1236](https://github.com/ueberdosis/tiptap/issues/1236) ([0b67f18](https://github.com/ueberdosis/tiptap/commit/0b67f18e3a109609cd9b2371396c5f6b8ed85f96))

# [2.0.0-beta.40](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.39...@pikun/core@2.0.0-beta.40) (2021-04-27)
...
# [2.0.0-beta.39](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.38...@pikun/core@2.0.0-beta.39) (2021-04-27)
...
# [2.0.0-beta.38](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.37...@pikun/core@2.0.0-beta.38) (2021-04-23)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.37](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.36...@pikun/core@2.0.0-beta.37) (2021-04-23)

### Bug Fixes

- better merge mark attributes for existing marks, fix [#1039](https://github.com/ueberdosis/tiptap/issues/1039) ([cfd29fa](https://github.com/ueberdosis/tiptap/commit/cfd29fac86e03d72a0c05ec8d26aac905d19c5a2))

# [2.0.0-beta.36](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.35...@pikun/core@2.0.0-beta.36) (2021-04-22)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.35](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.34...@pikun/core@2.0.0-beta.35) (2021-04-21)
...
# [2.0.0-beta.34](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.33...@pikun/core@2.0.0-beta.34) (2021-04-20)

### Bug Fixes

- fix a bug when dragging node views ([4e6d43b](https://github.com/ueberdosis/tiptap/commit/4e6d43bbfb488d2987f71ad15732af8d25b9897a))

# [2.0.0-beta.33](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.32...@pikun/core@2.0.0-beta.33) (2021-04-20)

### Bug Fixes

- fix extension option merging ([aa002a0](https://github.com/ueberdosis/tiptap/commit/aa002a012bfe888c03da5cd32f98b40965a5fa7b))

# [2.0.0-beta.32](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.31...@pikun/core@2.0.0-beta.32) (2021-04-16)
...
# [2.0.0-beta.31](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.30...@pikun/core@2.0.0-beta.31) (2021-04-15)

### Bug Fixes

- fix type for emitUpdate, fix [#276](https://github.com/ueberdosis/tiptap/issues/276) ([4137e00](https://github.com/ueberdosis/tiptap/commit/4137e00d987c152b883022525056df94ad033be7))

# [2.0.0-beta.30](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.29...@pikun/core@2.0.0-beta.30) (2021-04-15)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.29](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.28...@pikun/core@2.0.0-beta.29) (2021-04-12)

### Bug Fixes

- fix adding mark only with insertContent(), fix [#264](https://github.com/ueberdosis/tiptap/issues/264) ([0a63123](https://github.com/ueberdosis/tiptap/commit/0a6312382f38af5b8fdf7f94fc4b6c1de1a15e25))

# [2.0.0-beta.28](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.27...@pikun/core@2.0.0-beta.28) (2021-04-12)

### Features

- add parentConfig to extension context for more extendable extensions, fix [#259](https://github.com/ueberdosis/tiptap/issues/259) ([5e1ec5d](https://github.com/ueberdosis/tiptap/commit/5e1ec5d2a66be164f505d631f97861ab9344ba96))

# [2.0.0-beta.27](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.26...@pikun/core@2.0.0-beta.27) (2021-04-09)

### Bug Fixes

- add scrollIntoView for insertContent ([e7fe724](https://github.com/ueberdosis/tiptap/commit/e7fe7248af44df66fe322045953f8df186d82bec))

# [2.0.0-beta.26](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.25...@pikun/core@2.0.0-beta.26) (2021-04-09)

### Bug Fixes

- fix a bug when detecting changes within node views ([708ac94](https://github.com/ueberdosis/tiptap/commit/708ac94cebce2ed9304ae7e87eb4c3251758f903))

# [2.0.0-beta.25](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.24...@pikun/core@2.0.0-beta.25) (2021-04-09)

### Bug Fixes

- fixed type for Content ([39147f5](https://github.com/ueberdosis/tiptap/commit/39147f5b02388b68ddea91d40bd2e846597f813b))

# [2.0.0-beta.24](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.23...@pikun/core@2.0.0-beta.24) (2021-04-08)

### Bug Fixes

- improve drag position for node views even more ([d2c5b71](https://github.com/ueberdosis/tiptap/commit/d2c5b71c28b04ff64715ff6562e7dcb01cfd7ec8))

# [2.0.0-beta.23](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.22...@pikun/core@2.0.0-beta.23) (2021-04-08)

### Bug Fixes

- improve drag position for node views ([5e5b8db](https://github.com/ueberdosis/tiptap/commit/5e5b8db6eb707aa570b462caf184401189228b02))

# [2.0.0-beta.22](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.21...@pikun/core@2.0.0-beta.22) (2021-04-08)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.21](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.20...@pikun/core@2.0.0-beta.21) (2021-04-08)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.20](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.19...@pikun/core@2.0.0-beta.20) (2021-04-07)

### Features

- add resetAttributes() command, deprecate resetNodeAttributes() ([3334d93](https://github.com/ueberdosis/tiptap/commit/3334d930f30bd4acb5c314b4ec1934b6a1e0b712))

# [2.0.0-beta.19](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.18...@pikun/core@2.0.0-beta.19) (2021-04-07)

### Features

- add updateAttributes() command, deprecate updateNodeAttributes(), fix [#254](https://github.com/ueberdosis/tiptap/issues/254) ([aac32b4](https://github.com/ueberdosis/tiptap/commit/aac32b4df6a1dfd93500e09d3433fcd8acad5fbe))

# [2.0.0-beta.18](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.17...@pikun/core@2.0.0-beta.18) (2021-04-07)

### Features

- add priority option to extensions ([bb1ae65](https://github.com/ueberdosis/tiptap/commit/bb1ae659a463e97a7ada15af711347b5c004897a))

# [2.0.0-beta.17](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.16...@pikun/core@2.0.0-beta.17) (2021-04-07)

### Bug Fixes

- remove debug log ([beb96c5](https://github.com/ueberdosis/tiptap/commit/beb96c5cbfdb81869763e23f82f5ab270c30f0ea))

# [2.0.0-beta.16](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.15...@pikun/core@2.0.0-beta.16) (2021-04-07)

### Features

- add insertContent() command, deprecate insertText(), insertHTML() and insertNode() ([b8d9b7d](https://github.com/ueberdosis/tiptap/commit/b8d9b7d4c70b38fb9eec3c079be8243d30166e5e))

# [2.0.0-beta.15](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.14...@pikun/core@2.0.0-beta.15) (2021-04-06)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.14](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.13...@pikun/core@2.0.0-beta.14) (2021-04-04)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.13](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.12...@pikun/core@2.0.0-beta.13) (2021-04-02)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.12](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.11...@pikun/core@2.0.0-beta.12) (2021-04-01)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.11](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.10...@pikun/core@2.0.0-beta.11) (2021-04-01)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.10](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.9...@pikun/core@2.0.0-beta.10) (2021-03-31)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.9](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.8...@pikun/core@2.0.0-beta.9) (2021-03-28)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.8](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.7...@pikun/core@2.0.0-beta.8) (2021-03-28)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.7](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.6...@pikun/core@2.0.0-beta.7) (2021-03-28)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.6](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.5...@pikun/core@2.0.0-beta.6) (2021-03-24)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.5](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.4...@pikun/core@2.0.0-beta.5) (2021-03-18)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.4](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.3...@pikun/core@2.0.0-beta.4) (2021-03-18)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.3](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.2...@pikun/core@2.0.0-beta.3) (2021-03-16)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.2](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-beta.1...@pikun/core@2.0.0-beta.2) (2021-03-09)

**Note:** Version bump only for package @pikun/core

# [2.0.0-beta.1](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.22...@pikun/core@2.0.0-beta.1) (2021-03-05)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.22](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.21...@pikun/core@2.0.0-alpha.22) (2021-02-28)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.21](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.20...@pikun/core@2.0.0-alpha.21) (2021-02-26)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.20](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.19...@pikun/core@2.0.0-alpha.20) (2021-02-26)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.19](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.18...@pikun/core@2.0.0-alpha.19) (2021-02-18)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.18](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.17...@pikun/core@2.0.0-alpha.18) (2021-02-16)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.17](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.16...@pikun/core@2.0.0-alpha.17) (2021-02-16)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.16](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.15...@pikun/core@2.0.0-alpha.16) (2021-02-07)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.15](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.14...@pikun/core@2.0.0-alpha.15) (2021-02-05)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.14](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.13...@pikun/core@2.0.0-alpha.14) (2021-01-29)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.13](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.12...@pikun/core@2.0.0-alpha.13) (2021-01-29)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.12](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.11...@pikun/core@2.0.0-alpha.12) (2021-01-28)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.11](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.10...@pikun/core@2.0.0-alpha.11) (2021-01-28)

### Bug Fixes

- don’t merge classes ([dba0c1a](https://github.com/ueberdosis/tiptap/commit/dba0c1ac15e9beda3ebd027c67c969a4fe7ae7c7))

# [2.0.0-alpha.10](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.9...@pikun/core@2.0.0-alpha.10) (2021-01-06)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.9](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.8...@pikun/core@2.0.0-alpha.9) (2020-12-18)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.8](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.7...@pikun/core@2.0.0-alpha.8) (2020-12-18)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.7](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.6...@pikun/core@2.0.0-alpha.7) (2020-12-02)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.6](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.5...@pikun/core@2.0.0-alpha.6) (2020-11-19)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.5](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.4...@pikun/core@2.0.0-alpha.5) (2020-11-18)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.4](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.3...@pikun/core@2.0.0-alpha.4) (2020-11-16)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.3](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.2...@pikun/core@2.0.0-alpha.3) (2020-11-16)

### Reverts

- Revert "use global namespace" ([0c9ce26](https://github.com/ueberdosis/tiptap/commit/0c9ce26c02c07d88a757c01b0a9d7f9e2b0b7502))

# [2.0.0-alpha.2](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.1...@pikun/core@2.0.0-alpha.2) (2020-11-16)

**Note:** Version bump only for package @pikun/core

# [2.0.0-alpha.1](https://github.com/ueberdosis/tiptap/compare/@pikun/core@2.0.0-alpha.0...@pikun/core@2.0.0-alpha.1) (2020-11-16)
