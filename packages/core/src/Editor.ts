...
import type { MarkType, Node as ProseMirrorNode, NodeType, Schema } from '@pikun/pm/model';
import type { Plugin, PluginKey, Transaction } from '@pikun/pm/state';
import { EditorState } from '@pikun/pm/state';
import { EditorView } from '@pikun/pm/view';
