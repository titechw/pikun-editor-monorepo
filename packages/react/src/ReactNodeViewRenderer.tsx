...
import { getRenderedAttributes, NodeView } from '@pikun/core';
import type { Node, Node as ProseMirrorNode } from '@pikun/pm/model';
import type { Decoration, DecorationSource, NodeView as ProseMirrorNodeView } from '@pikun/pm/view';
