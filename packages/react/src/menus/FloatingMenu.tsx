import type { FloatingMenuPluginProps } from '@pikun/extension-floating-menu';
import { FloatingMenuPlugin } from '@pikun/extension-floating-menu';
import { useCurrentEditor } from '@pikun/react';
